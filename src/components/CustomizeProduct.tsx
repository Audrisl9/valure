const CustomizeProduct = () => {
  return (
    <div className="flex flex-col gap-6">
      <h4 className="font-medium">Chosee a color</h4>
      <ul className="flex items-center gap-3">
        ...
        <div className="absolute w-10 h-[2px] bg-black rotate-45 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" />
        </li>
      </ul>
      ...
      <ul className="flex items-center gap-3">
        ...
        <li className="ring-1 ring-pink-200 text-white bg-pink-200 rounded-md py-1 px-4 text-sm cursor-pointer">
          Large
        </li>
      </ul>
    </div>
